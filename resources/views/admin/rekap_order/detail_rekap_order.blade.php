            ...
            <div class="card-body">
                ...
                <div class="mb-4" style="max-width: 400px;">
                    <div class="d-flex justify-content-between align-items-center py-3 px-2">
                        ...
                        <span class="fs-5">{{ $totalOrderMasuk }} Order Layanan</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center py-3 px-2">
                        <span class="fw-semibold fs-5">Total Order Selesai</span>
                        <span class="fs-5">{{ $totalOrderSelesai }} Order Layanan</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center py-3 px-2">
                        <span class="fw-semibold fs-5">Pendapatan</span>
                        <span class="fs-5">Rp. {{ number_format($totalPendapatan, 0, ',', '.') }}</span>
                    </div>
                </div>
